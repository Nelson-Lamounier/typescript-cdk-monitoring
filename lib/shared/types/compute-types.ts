...
// ========================================
// ECS Application Configuration Types
// (Migrated from lib/types/ecs-service-config.ts)
// ========================================

/**
 * EBS Volume Configuration for ECS EC2 instances
 */
...
/**
 * ECS Container Configuration for service deployment
 * Note: Renamed from ContainerConfig to avoid conflict with task definition ContainerConfig
 */
...
/**
 * ECS Service Configuration for application deployment
 */
...
/**
 * ECS Application Stack Configuration
 */
